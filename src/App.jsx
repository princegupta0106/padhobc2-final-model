      ...
      <AuthProvider>
        ...
        <Routes>
          ...
          >
            ...
            <Route path="course/:courseId/upload" element={<UploadResource />} />
            <Route path="skill-course/:courseId" element={<SkillCoursePage />} />
            <Route path="skill-course/:courseId/upload" element={<UploadResource />} />
            ...
            <Route path="timetable" element={<div className="p-8">Timetable Creator - Coming Soon</div>} />
            <Route path="resources" element={<div className="p-8">Resources - Coming Soon</div>} />
            <Route path="resume" element={<div className="p-8">Resume - Coming Soon</div>} />
            <Route path="cgpa" element={<div className="p-8">CGPA Calculator - Coming Soon</div>} />
            <Route path="misc" element={<div className="p-8">Miscellaneous - Coming Soon</div>} />
          </Route>
