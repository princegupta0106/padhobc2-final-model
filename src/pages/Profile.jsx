...
const Profile = () => {
  ...
  const { user, userProfile, updateUserProfile, uploadProfileImage } = useAuth();
  const [isEditing, setIsEditing] = useState(false);
  const [displayName, setDisplayName] = useState(userProfile?.displayName || '');
  const [bio, setBio] = useState(userProfile?.bio || '');
  const [collegeId, setCollegeId] = useState(userProfile?.collegeId || 'BITS_PILANI');
    ...
    <div className="min-h-screen bg-gray-50 py-4 md:py-8">
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-8">
        <div className="bg-white rounded-lg shadow-sm p-4 md:p-8">
          <h1 className="text-2xl md:text-3xl font-bold text-gray-800 mb-6 md:mb-8">Profile</h1>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <p className="text-gray-800 text-lg">{userProfile?.displayName || 'Not set'}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-800">
                    {colleges.find(c => c.id === userProfile?.collegeId)?.name || 'Not set'}
                  </p>
                  {isEditing && (
