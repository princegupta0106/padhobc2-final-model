...
const Skills = () => {
  ...
  if (!userProfile?.collegeId) {
    return (
      ...
      >
        <div
          className={`p-6 rounded-lg shadow-sm text-center max-w-md ${
        ...
        >
          ...
          >
            You need to be part of a college to access skills.
          </p>
        </div>
      </div>
    );
        ...
        <div className="max-w-6xl mx-auto px-4 md:px-8">
          <div className="mb-8">
            ...
            <p className={isDarkMode ? "text-gray-400" : "text-gray-600"}>
              Choose a skill category to explore courses
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {skillCategories.map((skill) => {
              ...
              return (
                ...
                >
                  <div
                    className={`bg-gradient-to-br ${skill.color} rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1`}
                  >
                    <div className="flex items-center justify-between mb-4">
                      <div
                        className={`p-3 ${skill.bgColor} rounded-lg bg-opacity-20`}
                      >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredCourses.map((course) => (
              <div
                ...
                className={`rounded-lg shadow-sm hover:shadow-md transition-all cursor-pointer overflow-hidden group ${
                  isDarkMode ? "bg-gray-800" : "bg-white"
                }`}
              >
                <div
                  className={`h-2 bg-gradient-to-r ${selectedSkill.color}`}
                ></div>
                <div className="p-6">
                  <h3
